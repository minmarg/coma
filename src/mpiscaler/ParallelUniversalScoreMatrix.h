...
//
// This class encompasses methods to scale profile scoring matrix to the
// given lambda parameter. Since the matrix commonly can be large, scaling is
...
protected:
    ...
    double              ComputeScore( const FrequencyVector&, const FrequencyVector& ) const;
    double              VectorScoreProbability( const FrequencyVector&, const FrequencyVector& ) const;
