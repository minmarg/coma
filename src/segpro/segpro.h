...
<>\n\
\n\
SEG filter for profiles or multiple alignments given in FASTA.\n\
...
-o <output>     [Filename]  Output whose format (either fasta or binary) is\n\
                            determined by the format of input.\n\
