...
public:
    ...
    void        Clear();
    void        Push( double w, double delbeg, double delend, int delta, char );//push values
    void        PushAt( double w, double delbeg, double delend, int delta, char, int pos );
...
private:
    ...
    int     scalefactor;            //a factor to scale gap costs
    const Configuration*
