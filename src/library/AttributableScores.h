...
public:
    ...
    void                ComputeStatisticalParameters( bool = true );    //compute all statistical parameters that are required
    void                ComputeProbabilitiesAndLambda();                //compute score probabilities and statistical parameter lambda
...
protected:
    ...
    void                ComputeScoreProbabilities();                //compute probabilities to observe scores at each position
    void                ComputeScalingLambda();                     //compute scaling parameter lambda
    ...
    void                ComputeKarlinsK();                          //compute parameter K, expression of which is given by Karlin et al.
